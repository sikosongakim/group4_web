...
$sql = "SELECT * FROM staff WHERE first_name LIKE '%$search_query%' OR last_name LIKE '%$search_query%' OR gender LIKE '%$search_query%' OR position LIKE '%$search_query%' OR shift LIKE '%$search_query%' OR off_day LIKE '%$search_query%'"; // Add off_day to the search query
...
<head>
    ...
    <link rel="stylesheet" href="admin/adminstyle3.css">
