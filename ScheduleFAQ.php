        ...
        <div class="faq-list">
            <div class="faq">
                ...
                <div class="ans">
                    ...
                    <img src="ChangeSchedule.png" alt="ChangeSchedule" style="width: 500px; height: 80px; margin-top: 20px;">
                    </p>
                </div>
            </div>
            <div class="faq">
                ...
                <p>To view your current schedule, click on the View Schedule tab in the navigation menu. 
                    ...
                    <img src="ViewSchedule.png" alt="ViewSchedule" style="width: 500px; height: 80px; margin-top: 20px;">
                    </p>
                </div>
            </div>
            <div class="faq">
                ...
                <p>Once you submit a schedule change request, it will be sent to the administrator for approval. 
                    ...
                    <img src="status.png" alt="Status" style="width: 600px; height: 200px; margin-top: 20px;">
                    </p>
                </div>
            </div>
            <div class="faq">
